...
const colors = [
  ...
  ['text-color-pickle-50', '#f9fbe7'],
  ['text-color-pickle-100', '#f0f4c3'],
  ['text-color-pickle-200', '#e6ee9c'],
  ['text-color-pickle-300', '#dce775'],
  ['text-color-pickle-400', '#d4e157'],
  ['text-color-pickle-500', '#cddc39'],
  ['text-color-pickle-600', '#c0ca33'],
  ['text-color-pickle-700', '#afb42b'],
  ['text-color-pickle-800', '#9e9d24'],
  ['text-color-pickle-900', '#827717'],
