      ...
      <div className="atomikui-post__hd">
        ...
        <div className="atomikui-post__metadata">
          ...
          <List type="horizontal" className="atomikui-post__actions">
            {facebookLink && (
              <ListItem>
                <Link href={facebookLink} title="Facebook">
            ...
            {twitterLink && (
              <ListItem>
                <Link href={twitterLink} title="Twitter">
            ...
            {linkedInLink && (
              <ListItem>
                <Link href={linkedInLink} title="LinkedIn">
            ...
            <ListItem>
              <Button
                theme="link"
                title={isBookmarked ? 'Unsave Story' : 'Save Story'}
                onClick={() => {
                  setBookmarked(!bookmarked);
                }}
              >
                <svg
                  fill={bookmarked ? '#027abf' : '#444'}
